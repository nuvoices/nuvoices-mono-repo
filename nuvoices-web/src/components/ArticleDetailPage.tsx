...
interface ArticleDetailPageProps {
  ...
  basePath: 'magazine' | 'news' | 'podcast';
}

export function ArticleDetailPage({ post, previousPost, nextPost, basePath }: ArticleDetailPageProps) {
  return (
    <div className="min-h-screen bg-[#f4ecea]">
      {/* Hero Section with Featured Image */}
      {post.featuredImage?.asset?.url && (
        <div className="relative bg-[#f4ecea] max-w-[45rem] mx-auto -mx-[2.5rem] md:mx-auto md:px-[2.5rem]">
          <Image
      ...
      <div className="max-w-[35.71875rem] mx-auto px-[2.5rem] py-[3rem]">
