          ...
          <div className="container mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-6">
                <a href="/" className="flex items-center gap-2">
                  <div className="w-10 h-10 bg-pink-400 rounded-full flex items-center justify-center">
                    <span className="text-white text-xl font-bold">女</span>
                  </div>
                </a>
              ...
              <nav className="flex items-center gap-8">
                <a href="/about" className="text-gray-800 hover:text-gray-600 text-sm">About</a>
                <a href="/magazine" className="text-gray-800 hover:text-gray-600 text-sm">Magazine</a>
                <a href="/podcast" className="text-gray-800 hover:text-gray-600 text-sm">Podcast</a>
                <a href="/events" className="text-gray-800 hover:text-gray-600 text-sm">Events</a>
                <a href="/directory" className="text-gray-800 hover:text-gray-600 text-sm">Directory</a>
              </nav>
            </div>
          </div>
        </header>
