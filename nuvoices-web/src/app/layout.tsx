          ...
          <div className="container mx-auto px-6">
            <nav className="flex items-center justify-between h-16">
              ...
              <div className="flex items-center gap-8">
                ...
                <a href="/magazine" className="text-gray-700 hover:text-gray-900 text-sm font-medium">Magazine</a>
                <a href="/podcast" className="text-gray-700 hover:text-gray-900 text-sm font-medium">Podcast</a>
                <a href="/events" className="text-gray-700 hover:text-gray-900 text-sm font-medium">Events</a>
                <a href="/directory" className="text-gray-700 hover:text-gray-900 text-sm font-medium">Directory</a>
              </div>
            </nav>
          </div>
        </header>
